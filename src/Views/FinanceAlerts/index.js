...
z-index: 10;
`;
class FinanceAlert extends React.Component {
    ...
    async getConfigs() {
        ...
        let apiResponse = await APIService.makeApiGetRequest("schedulealerts/configs/list");
    ...
    async updateConfigs() {
        ...
        if (!privilegeList.includes("update_api_configurations")) {
            ...
            let result = await APIService.makePostRequest("schedulealerts/configs/update", params);
            if (result.success) {
                notification.addNotification({
    ...
    render() {
        return (
            <Aux>
                ...
                <Row>
                    <Col>
                        <Card title='Training Schedule Alert Configurations' isOption>
                ...
                >
                    ...
                    <div className="card">
                        ...
                        <center><h3>Schedule Alerts Configurations</h3></center>
