...
class ApiUsers extends React.Component {
    ...
    async getSystemusers(pagenum) {
        ...
        let apiResponse = await APIService.makeApiGetRequest("users/api/" + pagenum + "/10");
    ...
    async getSystemusersReport() {
        ...
        if (apiResponse.status == 403) {
            ...
            filteredReport = apiResponse.filter(r => {
                return r.apiuser == false && r.merchant.id == AuthenticationService.getUser().data.user.merchants.id;
            });
    ...
    async updateUsers() {
        ...
        //check permissions
            ...
            if (this.state.updated_username == null || this.state.updated_username === '') {
                this.setState({ show_progress_status: false });
            ...
            } else if (this.state.updated_password == null || this.state.updated_password === '') {
                this.setState({ show_progress_status: false });
                ...
                params["username"] = this.state.updated_username;
                params["rawpass"] = this.state.updated_password;
    ...
    async saveUsers() {
        ...
        const notification = this.notificationSystem.current;
            ...
            if (this.state.username == null || this.state.username === '') {
                ...
                let result = await APIService.makePostRequest("user/api/save", params);
                if (result.success) {
                    notification.addNotification({
                        message: 'Api user saved',
                        level: 'success',
                        autoDismiss: 5
                    });
                    this.closeAddDialog();
        ...
        return (
            ...
            <IconButton onClick={() =>
               this.setState({passwordvisible:true}) 
                ...
                <VisibilityOff style={{ color: "green" }} titleAccess='View password' />
                            ...
                            {this.state.users_temp.map(
                                (u, index) => (
                                    <Tr style={{ border: '1px solid' }} key={index}>
                                        ...
                                        <Td>
                                            {this.state.passwordvisible ? u.rawpass: this.viewPassword(u)}
                                        </Td>
                        ...
                        <div className="card-body text-center">
                            ...
                            <Row>
                                ...
                                <Col>
                                    ...
                                    <div className="input-group mb-3">
                                        <input type="text" className="form-control" style={{ color: '#000000' }} placeholder="Api username" value={this.state.username} onChange={e => this.handleChange(e, "username")} />
                                    </div>


                                    <div className="input-group mb-3">
                                        <input type="email" className="form-control" style={{ color: '#000000' }} placeholder="Api password" value={this.state.password} onChange={e => this.handleChange(e, "password")} />
                                    </div>

                                    <div className="input-group mb-3">
                                        <input type="description" className="form-control" style={{ color: '#000000' }} placeholder="Description" value={this.state.description} onChange={e => this.handleChange(e, "description")} />
                                    </div>
                        ...
                        <div className="card-body text-center">
                            ...
                            <Row>
                                ...
                                <Col>
                                    ...
                                    <div className="input-group mb-3">
                                        <input type="text" className="form-control" style={{ color: '#000000' }} placeholder="Api Username" value={this.state.updated_username} onChange={e => this.handleChange(e, "updated_username")} />
                                    </div>


                                    <div className="input-group mb-3">
                                        <input type="email" className="form-control" style={{ color: '#000000' }} placeholder="Api Password" value={this.state.updated_password} onChange={e => this.handleChange(e, "updated_password")} />
                                    </div>

                                    <div className="input-group mb-3">
                                        <input type="description" className="form-control" style={{ color: '#000000' }} placeholder="Description" value={this.state.updated_description} onChange={e => this.handleChange(e, "updated_description")} />
                                    </div>
                                </Col>
                            </Row>
