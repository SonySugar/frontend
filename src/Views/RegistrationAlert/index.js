...
class RegistrationAlert extends React.Component {
    ...
    async getConfigs() {
        ...
        let apiResponse = await APIService.makeApiGetRequest("registrationalert/configs/list");
    ...
    async updateConfigs() {
        ...
        if (!privilegeList.includes("update_api_configurations")) {
            ...
            let result = await APIService.makePostRequest("registrationalert/configs/update", params);
            if (result.success) {
                notification.addNotification({
    ...
    render() {
        return (
            <Aux>
                ...
                <Row>
                    <Col>
                        <Card title='Registration Alert Configurations' isOption>
                ...
                >
                    ...
                    <div className="card">
                        ...
                        <center><h3>Registration Alert Configurations</h3></center>
