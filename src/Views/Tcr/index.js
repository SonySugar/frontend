...
class Tcr extends React.Component {
    ...
    async getTcr(pagenum) {
        //call API
        const notification = this.notificationSystem.current;
        let apiResponse = await APIService.makeApiGetRequest("tcr_requests/" + pagenum + "/10");
        ...
        if (apiResponse.status == 403) {
            ...
            this.setState({ tcr: apiResponse, tcr_temp: apiResponse });
    ...
    async getTcrReport() {
        //call API
        const notification = this.notificationSystem.current;
        let apiResponse = await APIService.makeApiGetRequest("tcr_requests");
        ...
        if (apiResponse.status == 403) {
            ...
            apiResponse.forEach(r => {
                ...
                params["physicaladdress"] = r.physicaladdress;
    ...
    render() {
        ...
        return (
            <Aux>
                ...
                <Card title='Temporary contract requests' isOption>
                    ...
                    <br />
                    <br />
                    <CSVLink data={this.state.report} headers={headers} filename='Temporary_Contract_Requests.csv'>

                        <FaFileExcel size={50} color='green' title='Download Temporary contract requests' />
                    </CSVLink>
                    <IconButton onClick={() =>
                        this.generatePDF()
                    }>
                        <FaFilePdf title='Download temporary requests' size={50} color='red' />
                    </IconButton>
                    <IconButton onClick={() =>
                        this.RemovePage()
                    } >
                    ...
                    <Table>
                        ...
                        {this.state.tcr_temp == null || this.state.tcr_temp.length == 0 ? <Tbody>
                            <Tr style={{ border: '1px solid' }} key={0}>
                                <Td>No data available ......</Td>
                            </Tr>
                        </Tbody> : <Tbody>
                            {this.state.tcr_temp.map(
                                (u, index) => (
                    ...
                    <div className="card">
                        ...
                        <div className="card-body text-center">
                            ...
                            {this.state.showmore ? <Row>
                                ...
                                <label style={{ color: '#000000' }}><b>Physical address</b></label>
                                <div className="input-group mb-3">
                                    <input type="text" className="form-control" style={{ color: '#000000' }} value={this.state.physicaladdress} readOnly />
                                </div>
